#!/usr/bin/env bash
export M2_REPO_LOCATION=/home/anoukh/.m2
...
java -XX:+UnlockCommercialFeatures -XX:+FlightRecorder -Xmx4g -Xms4g -cp $CLASSPATH org.wso2.siddhi.debs2016.query.Run $1 $2 $3 $4
