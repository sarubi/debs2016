#!/usr/bin/env bash
export M2_REPO_LOCATION=/home/debs2016/.m2
...
export DATASETS_FOLDER=/usr/wso2/DEBS/data

java -XX:+UnlockCommercialFeatures -XX:+FlightRecorder -XX:FlightRecorderOptions=defaultrecording=true,dumponexit=true -Xmx8g -Xms8g -cp $CLASSPATH org.wso2.siddhi.debs2016.query.Query2Disruptor $1 $2 $3 $4
